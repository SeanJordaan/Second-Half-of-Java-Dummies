...
public class PizzaOrder extends Application
{
 ...
 {
 stage = primaryStage;
 // Create the name label and text field →32  A label and text field are created for the customer’s name.
 //we also set the width and the prompt text here 
 ...
 // Create the phone number label and text field →40  A label and text field are created for the customer’s number same
//as on thop here .
 ...
 // Create the address label and text field →48  A label and text field are created for the customer’s address
 ...
 // Create the size pane →56 A label and three radio buttons are created for the pizza’s size. The 
...
rdoSmall.setToggleGroup(groupSize);
 ...
 VBox paneSize = new VBox(lblSize, rdoSmall, rdoMedium, rdoLarge);//Here we putting the buttons in the VBox 
 paneSize.setSpacing(10);
 // Create the crust pane →70 A label and two radio buttons are created for the pizza’s crust style. 
 ...
 // Create the toppings pane →82 A label and three check boxes are created for the pizza’s toppings. The 
 ...
 // Create the buttons →92 The OK and Cancel buttons are created and added to an HBox named paneButton
 ...
 //The grid pane layout is created. The padding and horizontal and vertical gaps are set to 10 
 ...
 //The nodes are added to the pane. The name, phone number, and 
 //address labels and text fields are added
 ...
 // Set alignments and spanning →119 here we are aligning everything  
 ...
 // Set column widths →127  Column constraints are created to distribute the column widths evenly
 ...
 // Create the scene and the stage →136 The scene is created, and the stage is displayed.
 ...
 public void btnOK_Click() //→146 The btnOK_Click method is called when the user clicks OK. This 
 //method creates a summary of the customer’s order and displays it using the Alert class.
 {
 ...
 public String buildToppings(CheckBox chk, String msg) //→187 BuildToppings is simply a helper method that assists
         //in the construction of the message string
 {
 ...
 public void btnCancel_Click() //→201  The stage is closed when the user clicks the Close button.
 {
 stage.close();
 }
}