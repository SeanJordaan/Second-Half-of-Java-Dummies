...
public class WriteBinaryFile {
    ...
    public static void main(String[] args)// →4 The main method calls getMovies to get an array of Movie objects. Next, it 
    ...
    private static Movie[] getMovies() //→12 The getMovies method creates an array of movies to be written to the file.
    {
    ...
    private static DataOutputStream
            openOutputStream(String name)// →38 The openOutputStream method creates a DataOutputStream object so that 
    ...
    private static void writeMovie(Movie m, //→57 The writeMovie method accepts two parameters: the movie to be written 
    ...
    private static void closeFile(DataOutputStream out)// →73  The closeFile method closes the file
    {
        try {
            out.close();
        } catch (IOException e) {
    ...
    private static class Movie //→85  Once again, the Movie class is included as an inner class.
    {
